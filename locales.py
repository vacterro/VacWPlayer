...
LOCALES = {
    "en": {
        ...
        "cursor_mode_lbl": "Cursor outside game:",
        "cursor_mode_pause": "Pause clicks (resume on return)",
        "cursor_mode_stop": "Stop everything",
        "cursor_mode_off": "No guard (click anywhere)",
        "tt_cursor_mode": "When the cursor leaves the game window: Pause = skip clicks but keep spam armed, it resumes when the cursor returns; Stop = kill the running spam entirely; No guard = click even outside the game.",
        ...
        "cursor_move_lbl": "Move cursor after resurrect",
        "cursor_move_x_lbl": "Cursor X %:",
        "cursor_move_y_lbl": "Cursor Y %:",
        "cursor_move_hold_lbl": "Hold ms:",
        "pvp_after_res_lbl": "Start PvP after resurrect",
        "tt_cursor_move": "After resurrect the mouse is moved to the screen point given as percent of the screen size (default 75%, 25% = top-right) and tapped, so the champion starts walking there immediately.",
        "tt_pvp_after_res": "Start the PvP combo spam right after resurrect by sending its trigger key.",
    ...
    "ru": {
        ...
        "cursor_mode_lbl": "Курсор вне игры:",
        "cursor_mode_pause": "Пауза кликов (продолжить при возврате)",
        "cursor_mode_stop": "Остановить всё",
        "cursor_mode_off": "Без защиты (кликать где угодно)",
        "tt_cursor_mode": "Когда курсор покидает окно игры: Пауза = не кликать, но спам остаётся вооружён, продолжится при возврате курсора; Стоп = полностью убить запущенный спам; Без защиты = кликать даже вне игры.",
        ...
        "cursor_move_lbl": "Двигать курсор после возрождения",
        "cursor_move_x_lbl": "Курсор X %:",
        "cursor_move_y_lbl": "Курсор Y %:",
        "cursor_move_hold_lbl": "Удержание мс:",
        "pvp_after_res_lbl": "Запустить PvP после возрождения",
        "tt_cursor_move": "После возрождения мышь перемещается в точку экрана в процентах от размера экрана (по умолчанию 75%, 25% = правый верхний угол) и тапается, чтобы чемпион сразу пошёл туда.",
        "tt_pvp_after_res": "Запустить спам PvP-комбо сразу после возрождения, отправив его клавишу-триггер.",
