...
LOCALES = {
    "en": {
        ...
        "toggle_release_on_keys": "Keys release move hold (B recall always does)",
    ...
    "ru": {
        ...
        "toggle_release_on_keys": "Клавиши отпускают удержание движения (B-откат — всегда)",
